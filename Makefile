...
test-s-1 test-pbuf-0 test-tok-0 sample-cat test-bytewise test-rand	\
test-n-0 test-n-1 test-crc32 test-sha1 test-tagid test-byte

PROGS_OBJS = test-0.o test-1.o test-2.o test-3.o test-4.o	\
test-list-0.o test-s-0.o test-s-1.o test-pbuf-0.o test-tok-0.o	\
